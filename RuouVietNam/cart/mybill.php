<?php
    ...
    $listbill= loadall_billUser($_SESSION['user']['id_nguoidung']);
    // $listbill = loadall_bill($_SESSION['user']['id_nguoidung']);
    // echo "id nguoi dung: ".$_SESSION['user']['id_nguoidung'];
            ...
            <nav class="brown darken-2" id="menu">
                <div class="nav-wrapper container" >
                        ...
                        ?>  
                            ...
                            <?php } ?>
                            <li><a href="../login-form-20/login-form-20/thoat.php">Thoát</a></li>
                        <?php        
                            }else{
                        ?>
